...
public class CloudRepository {
    ...
    public Optional<FileToCloud> uploadFile(FileToCloud cloudFile, String authToken) throws StorageException {
    ...
    public Optional<FileToCloud> downloadFile(String authToken, String fileName) throws StorageException {
        Optional<Long> userId = getUserId(authToken);
        if (userId.isPresent()) {
    ...
    public Optional<FileToCloud> renameFile(String authToken, String fileName, String newFileName) throws StorageException {
        Optional<Long> userId = getUserId(authToken);
        if (userId.isPresent()) {
    ...
    public Optional<List<FileToCloud>> getFiles(String authToken, int limit) throws StorageException {
        Optional<Long> userId = getUserId(authToken);
        if (userId.isPresent()) {
